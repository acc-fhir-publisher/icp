Profile:        IcpTbiBistEncounter
Parent:         Encounter
Id:             acc-icp-tbi-bist-encounter
Title:          "ACC ICP TBI BIST Encounter Resource"
Description:    "The ICP TBI BIST Encounter profile is to be used by ICP suppliers to send subsequent ACC BIST submissions based on the Encounter resource."

* ^url = $icp-tbi-bist-encounter
* insert Acc-Metadata
...
* reasonReference 1..1
* reasonReference only Reference(IcpMeasurementBIST)
...
* extension contains
    ...
    $icp-referral-source named referral-source 1..1
