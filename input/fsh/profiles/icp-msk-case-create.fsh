Profile:        IcpMskCaseCreate
Parent:         acc-icp-case
Id:             acc-icp-msk-case-create
Title:          "ACC ICP MSK Case Create Resource"
Description:    "ICP MSK Case Create is to be used by the supplier to furnish ACC with the required information following the completion of the triage assessment and the decision to accept the patient into their ICP service."

* ^url = $icp-msk-case-create
* insert Acc-Metadata
