...
java $JAVA_OPTS -jar publisher.jar -ig . -no-sushi -excludelogbinaryformat -version-comparison n/a -ipa-comparison n/a -ips-comparison n/a -active-tables -usage-stats-opt-out
